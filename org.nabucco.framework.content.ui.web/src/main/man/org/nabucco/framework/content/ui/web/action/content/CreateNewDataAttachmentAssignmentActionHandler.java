...
/**
 * CreateNewDataAttachmentActionHandler
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public class CreateNewDataAttachmentAssignmentActionHandler extends CreateNewAttachmentSupport {

    public final static String ID = "Content.CreateNewDataAttachmentAssignment";

    private final String EDITOR_ID = "FileAttachmentAssignmentEditor";
    ...
    public ContentEntryAssignmentType getAssignmentType() {
        return ContentEntryAssignmentType.FILE;
    }

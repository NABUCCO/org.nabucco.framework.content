 ...
 */
package org.nabucco.framework.content.ui.rcp.communication.search;
...
public class SearchContentDelegate extends ServiceDelegateSupport {
     ...
     */
    public ContentEntryListMsg searchContentEntries(ContentEntrySearchRq message, ServiceSubContext... subContexts)
            throws ClientException {
        ...
        throw new ClientException("Cannot execute service operation: SearchContent.searchContentEntries");
    }
}

...
public class MaintainContentImpl extends ServiceSupport implements MaintainContent {
    ...
    private MaintainContentEntryAssignmentServiceHandler maintainContentEntryAssignmentServiceHandler;
    ...
    public void postConstruct() {
        ...
        this.maintainContentEntryAssignmentServiceHandler = injector
                .inject(MaintainContentEntryAssignmentServiceHandler.getId());
        if ((this.maintainContentEntryAssignmentServiceHandler != null)) {
            this.maintainContentEntryAssignmentServiceHandler.setPersistenceManager(persistenceManager);
            this.maintainContentEntryAssignmentServiceHandler.setLogger(super.getLogger());
        }
    ...
    public String[] getAspects(String operationName) {
        if ((ASPECTS == null)) {
            ...
            ASPECTS.put("maintainContentEntryAssignment", new String[] { "org.nabucco.aspect.permissioning",
    ...
    @Override
    public ServiceResponse<ContentEntryAssignmentMsg> maintainContentEntryAssignment(
            ServiceRequest<ContentEntryAssignmentMaintainRq> rq) throws MaintainException {
        if ((this.maintainContentEntryAssignmentServiceHandler == null)) {
            super.getLogger().error("No service implementation configured for maintainContentEntryAssignment().");
            throw new InjectionException("No service implementation configured for maintainContentEntryAssignment().");
        }
        ServiceResponse<ContentEntryAssignmentMsg> rs;
        this.maintainContentEntryAssignmentServiceHandler.init();
        rs = this.maintainContentEntryAssignmentServiceHandler.invoke(rq);
        this.maintainContentEntryAssignmentServiceHandler.finish();
        return rs;
    }

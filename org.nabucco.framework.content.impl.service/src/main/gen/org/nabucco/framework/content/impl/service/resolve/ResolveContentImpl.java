...
public class ResolveContentImpl extends ServiceSupport implements ResolveContent {
    ...
    private ResolveContentEntryAssignmentServiceHandler resolveContentEntryAssignmentServiceHandler;
    ...
    public void postConstruct() {
        ...
        this.resolveContentEntryAssignmentServiceHandler = injector.inject(ResolveContentEntryAssignmentServiceHandler
                .getId());
        if ((this.resolveContentEntryAssignmentServiceHandler != null)) {
            this.resolveContentEntryAssignmentServiceHandler.setPersistenceManager(persistenceManager);
            this.resolveContentEntryAssignmentServiceHandler.setLogger(super.getLogger());
        }
    ...
    public String[] getAspects(String operationName) {
        if ((ASPECTS == null)) {
            ...
            ASPECTS.put("resolveContentEntryAssignment", new String[] { "org.nabucco.aspect.permissioning",
    ...
    @Override
    public ServiceResponse<ContentEntryAssignmentMsg> resolveContentEntryAssignment(
            ServiceRequest<ContentEntryAssignmentResolveRq> rq) throws ResolveException {
        if ((this.resolveContentEntryAssignmentServiceHandler == null)) {
            super.getLogger().error("No service implementation configured for resolveContentEntryAssignment().");
            throw new InjectionException("No service implementation configured for resolveContentEntryAssignment().");
        }
        ServiceResponse<ContentEntryAssignmentMsg> rs;
        this.resolveContentEntryAssignmentServiceHandler.init();
        rs = this.resolveContentEntryAssignmentServiceHandler.invoke(rq);
        this.resolveContentEntryAssignmentServiceHandler.finish();
        return rs;
    }

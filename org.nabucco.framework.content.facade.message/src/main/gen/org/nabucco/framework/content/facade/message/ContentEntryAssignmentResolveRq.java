...
/**
 * ContentEntryAssignmentResolveRq<p/>Service DTO for ContentEntryAssignment<p/>
 *
 * @version 1.0
 * @author Leonid Agranovskiy, PRODYNA AG, 2012-02-22
 */
public class ContentEntryAssignmentResolveRq extends ServiceMessageSupport implements ServiceMessage {
    ...
    /** Constructs a new ContentEntryAssignmentResolveRq instance. */
    public ContentEntryAssignmentResolveRq() {
        super();
        this.initDefaults();
    }
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(
                ContentEntryAssignmentResolveRq.getPropertyDescriptor(CONTENTENTRYASSIGNMENT),
    ...
    public boolean equals(Object obj) {
        ...
        final ContentEntryAssignmentResolveRq other = ((ContentEntryAssignmentResolveRq) obj);
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(ContentEntryAssignmentResolveRq.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(ContentEntryAssignmentResolveRq.class).getAllProperties();
    }
}
